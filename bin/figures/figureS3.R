#!/usr/bin/env Rscript
# Produce figure S3 (Gene Repeats)
source('src/config.R')
...
ggsave('figures/4_figures/figureS3.pdf', figure, width = figure_width(figure), height = figure_height(figure), units = 'mm')
ggsave('figures/4_figures/figureS3.png', figure, width = figure_width(figure), height = figure_height(figure), units = 'mm')

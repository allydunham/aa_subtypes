#!/usr/bin/env Rscript
# Produce figure S5 (Frequency of rarer subtypes)
source('src/config.R')
...
ggsave('figures/4_figures/figureS5.pdf', figure, width = 187, height = 100, units = 'mm')
ggsave('figures/4_figures/figureS5.png', figure, width = 187, height = 100, units = 'mm')

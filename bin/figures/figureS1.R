...
p_freq_dist <- ggplot(sub_freqs, aes(x = num, y = freq)) + 
...
ggsave('figures/4_figures/figureS1.pdf', p_freq_dist, width = 187, height = 100, units = 'mm')
ggsave('figures/4_figures/figureS1.png', p_freq_dist, width = 187, height = 100, units = 'mm')

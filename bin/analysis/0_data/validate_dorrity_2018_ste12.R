...
dir.create('figures/0_data/per_study/dorrity_2018_ste12')
...
ggsave('figures/0_data/per_study/dorrity_2018_ste12/rep_correlation.pdf', p_paired, units = 'cm', height = 30, width = 30)
...
ggsave('figures/0_data/per_study/dorrity_2018_ste12/multi_mut_validation.pdf', p_sing_multi, units = 'cm', height = 15, width = 25)

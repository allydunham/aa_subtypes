...
dir.create('figures/0_data_properties/per_study/kitzman_2015_gal4')
...
ggsave('figures/0_data_properties/per_study/kitzman_2015_gal4/validate_selection_combination.pdf', p, units = 'cm', width = 25, height = 25)
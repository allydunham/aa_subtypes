...
dir.create('figures/0_data_properties/giacomelli_2018_tp53')
...
ggsave('figures/0_data_properties/giacomelli_2018_tp53/initial_experiment_cor.pdf', p_exp, width = 15, height = 15, units = 'cm')
...
ggsave('figures/0_data_properties/giacomelli_2018_tp53/codon_averaged_experiment_cor.pdf', p_exp_codon, width = 15, height = 15, units = 'cm')
...
ggsave('figures/0_data_properties/giacomelli_2018_tp53/conditions.pdf', p_cond, width = 15, height = 15, units = 'cm')

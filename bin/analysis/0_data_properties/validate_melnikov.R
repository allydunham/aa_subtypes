...
dir.create('figures/0_data_properties/melnikov_2014_aph3ii')
...
ggsave('figures/0_data_properties/melnikov_2014_aph3ii/initial_library_correlation.pdf', p_lib_test, units = 'cm', width = 18, height = 18)
...
ggsave('figures/0_data_properties/melnikov_2014_aph3ii/filtered_library_correlation.pdf', p_lib_filtered, units = 'cm', width = 18, height = 18)
########
...
ggsave('figures/0_data_properties/melnikov_2014_aph3ii/rel_conc_correlation.pdf', p_rel_conc, units = 'cm', width = 25, height = 25)
...
ggsave('figures/0_data_properties/melnikov_2014_aph3ii/drug_conc_distribution.pdf', p_drug_conc, units = 'cm', width = 25, height = 25)
...
ggsave('figures/0_data_properties/melnikov_2014_aph3ii/drug_correlation.pdf', p_drug_cors, units = 'cm', width = 25, height = 25)
